...
/**
 * Model definition for MultiEntry.
 *
 * <p>
...
public final class MultiEntry extends com.google.api.client.json.GenericJson {
	...
	/**
	 * @param transactions
	 *            transactions or {@code null} for none
	 */
	public MultiEntry setTransactions(java.util.List<Transaction> transactions) {
		this.transactions = transactions;
		return this;
	}

	@Override
	public MultiEntry set(String fieldName, Object value) {
		return (MultiEntry) super.set(fieldName, value);
	}

	@Override
	public MultiEntry clone() {
		return (MultiEntry) super.clone();
	}
