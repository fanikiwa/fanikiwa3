...
public class Offerreceipientendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class OfferReceipientEndpoint {
    ...
    /**
     * Create a request for the method "offerReceipientEndpoint.pulgeOfferandReceipient".
     *
     * This request holds the parameters needed by the offerreceipientendpoint server.  After setting
     * any optional parameters, call the {@link PulgeOfferandReceipient#execute()} method to invoke the
     * remote operation.
     *
     * @param id
     * @return the request
     */
    public PulgeOfferandReceipient pulgeOfferandReceipient(java.lang.Long id) throws java.io.IOException {
      PulgeOfferandReceipient result = new PulgeOfferandReceipient(id);
      initialize(result);
      return result;
    }

    public class PulgeOfferandReceipient extends OfferreceipientendpointRequest<com.sp.fanikiwa.entity.offerreceipientendpoint.model.RequestResult> {

      private static final String REST_PATH = "PulgeOfferandReceipient/{id}";

      /**
       * Create a request for the method "offerReceipientEndpoint.pulgeOfferandReceipient".
       *
       * This request holds the parameters needed by the the offerreceipientendpoint server.  After
       * setting any optional parameters, call the {@link PulgeOfferandReceipient#execute()} method to
       * invoke the remote operation. <p> {@link PulgeOfferandReceipient#initialize(com.google.api.clien
       ...
       * @since 1.13
       */
      protected PulgeOfferandReceipient(java.lang.Long id) {
        super(Offerreceipientendpoint.this, "POST", REST_PATH, null, com.sp.fanikiwa.entity.offerreceipientendpoint.model.RequestResult.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }

      @Override
      public PulgeOfferandReceipient setAlt(java.lang.String alt) {
        return (PulgeOfferandReceipient) super.setAlt(alt);
      }

      @Override
      public PulgeOfferandReceipient setFields(java.lang.String fields) {
        return (PulgeOfferandReceipient) super.setFields(fields);
      }

      @Override
      public PulgeOfferandReceipient setKey(java.lang.String key) {
        return (PulgeOfferandReceipient) super.setKey(key);
      }

      @Override
      public PulgeOfferandReceipient setOauthToken(java.lang.String oauthToken) {
        return (PulgeOfferandReceipient) super.setOauthToken(oauthToken);
      }

      @Override
      public PulgeOfferandReceipient setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (PulgeOfferandReceipient) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public PulgeOfferandReceipient setQuotaUser(java.lang.String quotaUser) {
        return (PulgeOfferandReceipient) super.setQuotaUser(quotaUser);
      }

      @Override
      public PulgeOfferandReceipient setUserIp(java.lang.String userIp) {
        return (PulgeOfferandReceipient) super.setUserIp(userIp);
      }
      ...
      public PulgeOfferandReceipient setId(java.lang.Long id) {
        this.id = id;
        return this;
      }

      @Override
      public PulgeOfferandReceipient set(String parameterName, Object value) {
        return (PulgeOfferandReceipient) super.set(parameterName, value);
      }
    }
  ...
  public class RemoveOfferReceipient extends OfferreceipientendpointRequest<com.sp.fanikiwa.entity.offerreceipientendpoint.model.RequestResult> {
    ...
    protected RemoveOfferReceipient(java.lang.Long id) {
      super(Offerreceipientendpoint.this, "DELETE", REST_PATH, null, com.sp.fanikiwa.entity.offerreceipientendpoint.model.RequestResult.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
