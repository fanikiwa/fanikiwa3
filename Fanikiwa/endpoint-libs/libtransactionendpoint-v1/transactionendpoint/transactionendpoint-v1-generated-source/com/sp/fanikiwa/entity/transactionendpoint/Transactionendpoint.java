...
public class Transactionendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class TransactionEndpoint {
    ...
    /**
     * Create a request for the method "transactionEndpoint.getAccountTransactions".
     *
     * This request holds the parameters needed by the transactionendpoint server.  After setting any
     * optional parameters, call the {@link GetAccountTransactions#execute()} method to invoke the
     * remote operation.
     *
     * @param content the {@link com.sp.fanikiwa.entity.transactionendpoint.model.Account}
     * @return the request
     */
    public GetAccountTransactions getAccountTransactions(com.sp.fanikiwa.entity.transactionendpoint.model.Account content) throws java.io.IOException {
      GetAccountTransactions result = new GetAccountTransactions(content);
      initialize(result);
      return result;
    }

    public class GetAccountTransactions extends TransactionendpointRequest<com.sp.fanikiwa.entity.transactionendpoint.model.CollectionResponseTransaction> {

      private static final String REST_PATH = "GetAccountTransactions";

      /**
       * Create a request for the method "transactionEndpoint.getAccountTransactions".
       *
       * This request holds the parameters needed by the the transactionendpoint server.  After setting
       * any optional parameters, call the {@link GetAccountTransactions#execute()} method to invoke the
       * remote operation. <p> {@link GetAccountTransactions#initialize(com.google.api.client.googleapis
       ...
       * @since 1.13
       */
      protected GetAccountTransactions(com.sp.fanikiwa.entity.transactionendpoint.model.Account content) {
      ...
      @Override
      public GetAccountTransactions setAlt(java.lang.String alt) {
        return (GetAccountTransactions) super.setAlt(alt);
      }

      @Override
      public GetAccountTransactions setFields(java.lang.String fields) {
        return (GetAccountTransactions) super.setFields(fields);
      }

      @Override
      public GetAccountTransactions setKey(java.lang.String key) {
        return (GetAccountTransactions) super.setKey(key);
      }

      @Override
      public GetAccountTransactions setOauthToken(java.lang.String oauthToken) {
        return (GetAccountTransactions) super.setOauthToken(oauthToken);
      }

      @Override
      public GetAccountTransactions setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (GetAccountTransactions) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public GetAccountTransactions setQuotaUser(java.lang.String quotaUser) {
        return (GetAccountTransactions) super.setQuotaUser(quotaUser);
      }

      @Override
      public GetAccountTransactions setUserIp(java.lang.String userIp) {
        return (GetAccountTransactions) super.setUserIp(userIp);
      }
      ...
      public GetAccountTransactions setCount(java.lang.Integer count) {
        this.count = count;
        return this;
      }
      ...
      public GetAccountTransactions setCursor(java.lang.String cursor) {
        this.cursor = cursor;
        return this;
      }

      @Override
      public GetAccountTransactions set(String parameterName, Object value) {
        return (GetAccountTransactions) super.set(parameterName, value);
      }
    }
    /**
     ...
     * @return the request
     */
    public GetMiniStatement getMiniStatement(java.lang.Long accountId) throws java.io.IOException {
      GetMiniStatement result = new GetMiniStatement(accountId);
      initialize(result);
      return result;
    }
    ...
    public class GetMiniStatement extends TransactionendpointRequest<com.sp.fanikiwa.entity.transactionendpoint.model.CollectionResponseTransaction> {
       ...
       * @since 1.13
       */
      protected GetMiniStatement(java.lang.Long accountId) {
        super(Transactionendpoint.this, "POST", REST_PATH, null, com.sp.fanikiwa.entity.transactionendpoint.model.CollectionResponseTransaction.class);
      ...
      public GetMiniStatement setAccountId(java.lang.Long accountId) {
    ...
    /**
     * Create a request for the method "transactionEndpoint.selectByAccountDateRange".
     *
     * This request holds the parameters needed by the transactionendpoint server.  After setting any
     * optional parameters, call the {@link SelectByAccountDateRange#execute()} method to invoke the
     * remote operation.
     *
     * @param sdate
     * @param content the {@link com.sp.fanikiwa.entity.transactionendpoint.model.Account}
     * @return the request
     */
    public SelectByAccountDateRange selectByAccountDateRange(com.google.api.client.util.DateTime sdate, com.sp.fanikiwa.entity.transactionendpoint.model.Account content) throws java.io.IOException {
      SelectByAccountDateRange result = new SelectByAccountDateRange(sdate, content);
      initialize(result);
      return result;
    }

    public class SelectByAccountDateRange extends TransactionendpointRequest<com.sp.fanikiwa.entity.transactionendpoint.model.CollectionResponseTransaction> {

      private static final String REST_PATH = "SelectByAccountDateRange/{sdate}";

      /**
       * Create a request for the method "transactionEndpoint.selectByAccountDateRange".
       *
       * This request holds the parameters needed by the the transactionendpoint server.  After setting
       * any optional parameters, call the {@link SelectByAccountDateRange#execute()} method to invoke
       * the remote operation. <p> {@link SelectByAccountDateRange#initialize(com.google.api.client.goog
       ...
       * @since 1.13
       */
      protected SelectByAccountDateRange(com.google.api.client.util.DateTime sdate, com.sp.fanikiwa.entity.transactionendpoint.model.Account content) {
        super(Transactionendpoint.this, "POST", REST_PATH, content, com.sp.fanikiwa.entity.transactionendpoint.model.CollectionResponseTransaction.class);
        this.sdate = com.google.api.client.util.Preconditions.checkNotNull(sdate, "Required parameter sdate must be specified.");
      }

      @Override
      public SelectByAccountDateRange setAlt(java.lang.String alt) {
        return (SelectByAccountDateRange) super.setAlt(alt);
      }

      @Override
      public SelectByAccountDateRange setFields(java.lang.String fields) {
        return (SelectByAccountDateRange) super.setFields(fields);
      }

      @Override
      public SelectByAccountDateRange setKey(java.lang.String key) {
        return (SelectByAccountDateRange) super.setKey(key);
      }

      @Override
      public SelectByAccountDateRange setOauthToken(java.lang.String oauthToken) {
        return (SelectByAccountDateRange) super.setOauthToken(oauthToken);
      }

      @Override
      public SelectByAccountDateRange setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (SelectByAccountDateRange) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public SelectByAccountDateRange setQuotaUser(java.lang.String quotaUser) {
        return (SelectByAccountDateRange) super.setQuotaUser(quotaUser);
      }

      @Override
      public SelectByAccountDateRange setUserIp(java.lang.String userIp) {
        return (SelectByAccountDateRange) super.setUserIp(userIp);
      }
      ...
      public SelectByAccountDateRange setSdate(com.google.api.client.util.DateTime sdate) {
        this.sdate = sdate;
        return this;
      }
      ...
      public SelectByAccountDateRange setCount(java.lang.Integer count) {
        this.count = count;
        return this;
      }
      ...
      public SelectByAccountDateRange setCursor(java.lang.String cursor) {
        this.cursor = cursor;
        return this;
      }

      @Override
      public SelectByAccountDateRange set(String parameterName, Object value) {
        return (SelectByAccountDateRange) super.set(parameterName, value);
      }
    }
  ...
  /**
   * Create a request for the method "deleteAccountTransactions".
   *
   * This request holds the parameters needed by the transactionendpoint server.  After setting any
   * optional parameters, call the {@link DeleteAccountTransactions#execute()} method to invoke the
   * remote operation.
   *
   * @param id
   * @return the request
   */
  public DeleteAccountTransactions deleteAccountTransactions(java.lang.Long id) throws java.io.IOException {
    DeleteAccountTransactions result = new DeleteAccountTransactions(id);
    initialize(result);
    return result;
  }

  public class DeleteAccountTransactions extends TransactionendpointRequest<com.sp.fanikiwa.entity.transactionendpoint.model.RequestResult> {

    private static final String REST_PATH = "accounttransactions/{id}";

    /**
     * Create a request for the method "deleteAccountTransactions".
     *
     * This request holds the parameters needed by the the transactionendpoint server.  After setting
     * any optional parameters, call the {@link DeleteAccountTransactions#execute()} method to invoke
     * the remote operation. <p> {@link DeleteAccountTransactions#initialize(com.google.api.client.goo
     * gleapis.services.AbstractGoogleClientRequest)} must be called to initialize this instance
     * immediately after invoking the constructor. </p>
     *
     * @param id
     * @since 1.13
     */
    protected DeleteAccountTransactions(java.lang.Long id) {
      super(Transactionendpoint.this, "DELETE", REST_PATH, null, com.sp.fanikiwa.entity.transactionendpoint.model.RequestResult.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }

    @Override
    public DeleteAccountTransactions setAlt(java.lang.String alt) {
      return (DeleteAccountTransactions) super.setAlt(alt);
    }

    @Override
    public DeleteAccountTransactions setFields(java.lang.String fields) {
      return (DeleteAccountTransactions) super.setFields(fields);
    }

    @Override
    public DeleteAccountTransactions setKey(java.lang.String key) {
      return (DeleteAccountTransactions) super.setKey(key);
    }

    @Override
    public DeleteAccountTransactions setOauthToken(java.lang.String oauthToken) {
      return (DeleteAccountTransactions) super.setOauthToken(oauthToken);
    }

    @Override
    public DeleteAccountTransactions setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (DeleteAccountTransactions) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public DeleteAccountTransactions setQuotaUser(java.lang.String quotaUser) {
      return (DeleteAccountTransactions) super.setQuotaUser(quotaUser);
    }

    @Override
    public DeleteAccountTransactions setUserIp(java.lang.String userIp) {
      return (DeleteAccountTransactions) super.setUserIp(userIp);
    }
    ...
    public DeleteAccountTransactions setId(java.lang.Long id) {
      this.id = id;
      return this;
    }

    @Override
    public DeleteAccountTransactions set(String parameterName, Object value) {
      return (DeleteAccountTransactions) super.set(parameterName, value);
    }
  }
