...
public class LoanUtil {
	...
	public static int GetAccountTerm(Loan loan, Date date) // return term in
															// days
	{
	...
	public static Loan GetLoan(Long Id) {
		...
		return lep.getLoanByID(Id);
	}

	public static Loan UpdateLoan(Loan loan) throws NotFoundException {
		LoanEndpoint lep = new LoanEndpoint();
		return lep.updateLoan(loan);
	}
