...
public class MailUtil {
	...
	public static void sendEmailWithPDF(String recipient, String subject,
			String content, String filename, Contract model, Class<?> pdf) {
		...
		try {
			...
			PDFUtil.writePdf(outputStream, model, pdf);
			...
			InternetAddress iaSender = new InternetAddress(KUFANIKIWAEMAIL,
					"Fanikiwa Admin");
