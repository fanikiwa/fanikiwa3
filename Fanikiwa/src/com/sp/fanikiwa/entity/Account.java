...
public class Account {
	...
	@Index private Date nextIntAccrualDate;
	private boolean accrueInSusp;
	//Interest Computation
	@Index private String interestComputationMethod; //Used in interest computation formular. Permissible values are -S simple; C compound
	@Index private String interestComputationTerm; //Used in int computation formula. Permissible values are - D1, D360, D365, M1, M30, Y
	
	//Interest Application
	 //This means when is the interest earned/paid for investments or expensed/paid for loans?. 
	@Index private String interestApplicationMethod;//Permissible values are - M monthly. Inst- when installment goes thro. All- when loan is finally paid
	@Index private Date lastIntAppDate;
	@Index private Date nextIntAppDate;
