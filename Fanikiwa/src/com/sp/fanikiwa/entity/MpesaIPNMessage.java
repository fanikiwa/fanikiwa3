...
public class MpesaIPNMessage {
	...
	@Id
	String mpesa_code; // Assumed to be unique The MPESA transaction code. : Eg.
						// BI55EQ862

	@Index
	private String mpesaIPNMessageID; // This is the IPN notification unique
										// number : Eg. 100
	private String orig; // This will be source of the notification. : Eg. MPESA
	@Index
	private String dest; // This will be same as your business terminal Msisdn :
							// Eg. 254722123456
	private String tstamp; // This is the timestamp for when the IPN
							// notification was received from MPESA. : Eg.
							// 2011-04-26 12:47:31.0
	private String text; // This is the full text message as received from
							// MPESA. : Eg. This is will be the full SMS
							// message.
	private String user; // If you provide us a username and password to access
							// your URL this parameter will contain the username
							// : Eg. Username for Developer URL
	private String pass; // If you provide us a username and password to access
							// your URL this parameter will contain the
							// password. : Eg. Password for Developer URL
	@Index
	private String mpesa_acc; // The Account as entered by the subscriber : Eg.
								// TEST
	@Index
	private String mpesa_msisdn; // The mobile number of the subscriber that has
									// sent the funds : Eg. 254722123456
	@Index
	...
	@Index
	private String mpesa_sender; // The name of the sender (subscriber). : Eg.
									// ALFRED
	@Index
