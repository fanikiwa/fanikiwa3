...
public class GroupOfferee extends Offeree {
	...
	private void FillMembers(String Groupname) {
		...
		Collection<Lendinggroupmember> grpmembers = (ep.selectgroupMembers(
				Groupname, null, null)).getItems();
		...
		Collection<Lendinggroup> subgroups = (lep.retrieveSubgroups(Groupname,
				null, null)).getItems();
		for (Lendinggroup lg : subgroups) // this is a nested group; find out
