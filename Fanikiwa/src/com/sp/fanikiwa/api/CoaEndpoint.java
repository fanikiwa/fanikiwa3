...
public class CoaEndpoint {
  ...
  public CollectionResponse<Coa> listCoa(
	 ...
	 *
	 * @param Coa the entity to be inserted.
	 * @return The inserted entity.
	 * @throws ConflictException 
	 */
	@ApiMethod(name = "insertCoa")
	public Coa insertCoa(
			Coa coa) throws ConflictException {
		if (coa.getId() != null) {
	 ...
	 *
	 * @param Coa the entity to be updated.
	 * @return The updated entity.
	 * @throws NotFoundException 
	 */
	@ApiMethod(name = "updateCoa")
	public Coa updateCoa(Coa Coa) throws NotFoundException {
		Coa record = findRecord(Coa.getId());
		if (record == null) {
	...
	public void removeCoa(@Named("id") Long id) throws NotFoundException {
