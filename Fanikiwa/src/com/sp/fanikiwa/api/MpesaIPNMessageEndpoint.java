...
public class MpesaIPNMessageEndpoint {
	...
	public MpesaIPNMessage insertMpesaIPNMessage(MpesaIPNMessage mpesaIPNMessage)
	...
	public MpesaIPNMessage updateMpesaIPNMessage(MpesaIPNMessage mpesaIPNMessage)
	...
	public void removeMpesaIPNMessage(@Named("id") String id)
			throws NotFoundException {
	...
	private CollectionResponse<MpesaIPNMessage> GetMpesaIPNMessagesFromQuery(
			Query<MpesaIPNMessage> query, String cursorString, Integer count) {
