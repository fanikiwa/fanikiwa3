...
public class InformdbEndpoint {
	...
	public Informdb insertInformdb(Informdb informdb) throws NotFoundException,
			ConflictException {
	...
	public RequestResult sendMail(@Named("to") String to,
		...
		try {
			...
			// MailUtil.sendEmailWithPDF(to, subject,body, "Test.PDF",
			// TestPDF.class);
			MailUtil.sendEmailWithPDF(to, subject, body,
					"FanikiwaContract.PDF", cont, ContractPDF.class);
			re.setSuccess(true);
